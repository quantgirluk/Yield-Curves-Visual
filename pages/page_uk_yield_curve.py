...
layout = dbc.Container([
    dbc.Row([
        dbc.Col(
            dcc.Graph(id='graph-uk', figure=ycp.plot_historical_yield_curve(df, source_text=source, id_vars='Date')),
    ...
    dbc.Row([
        dbc.Col(dcc.Graph(id="graph-uk-surface", figure=ycp.plot_yield_curve_surface(df,
                                                                                     source_text=source)),
                xs=12, sm=12, md=12, lg=12, xl=12, xxl=6, class_name='mt-4'),
        dbc.Col(
    ...
    dbc.Row([
        dbc.Col(
            dcc.Graph(figure=ycp.plot_line_spread(df, idx='Date', low='2Y', high='10Y',
                                                  source_text=source)),
            xs=12, sm=12, md=12, lg=12, xl=12, xxl=6, class_name='mt-4')
    ]),
